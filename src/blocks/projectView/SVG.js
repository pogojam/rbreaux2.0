...
const CloudSVG = ({className})=><svg className={className} width="162px" height="104px" viewBox="0 0 162 104" version="1.1">
    <g id="Page-4" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <g id="Desktop-HD" transform="translate(-507.000000, -391.000000)" stroke="black" stroke-width="3">
            <g id="Cloud" transform="translate(507.000000, 391.000000)">
                <path d="M41.7822001,36.6549436 L41.6025322,37.9485981 L33.7757009,37.9485981 C15.9503235,37.9485981 1.5,52.3989216 1.5,70.2242991 C1.5,88.0496765 15.9503235,102.5 33.7757009,102.5 L128.224299,102.5 C146.049676,102.5 160.5,88.0496765 160.5,70.2242991 C160.5,52.3989216 146.049676,37.9485981 128.224299,37.9485981 L122.8299,37.9485981 L122.650232,36.6549436 C119.865802,16.6063457 102.65253,1.5 82.2162162,1.5 C61.7799028,1.5 44.56663,16.6063457 41.7822001,36.6549436 Z" id="Combined-Shape"></path>
            </g>
        </g>
    </g>
</svg>

const GitSVG  = ({className})=><svg  className={className} xmlns="http://www.w3.org/2000/svg" width="49" height="49" viewBox="0 0 438.549 438.549">
...
const LinkedInSVG = ({className})=><svg className={className} xmlns="http://www.w3.org/2000/svg" width="49" height="49" viewBox="0 0 49.652 49.652">
    ...
    <g id="Symbols" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g id="Monitor" stroke={color}>
            <g>
                ...
                <rect id="Rectangle" strokeWidth="2" x="86" y="111" width="4" height="14"></rect>
                <rect id="Rectangle" strokeWidth="2" x="64" y="125" width="48" height="5" rx="2.5"></rect>
            </g>
        </g>
    </g>
</svg>
